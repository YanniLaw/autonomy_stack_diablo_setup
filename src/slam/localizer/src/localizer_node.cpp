...
void LocalizerNode::pointBodyToWorld(PointType const * const pi, PointType * const po, 
...
Eigen::Vector3d LocalizerNode::QuatnionToEulerAngles(Eigen::Quaterniond quat) {
...
void LocalizerNode::InitialPoseCB(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr init_pose) {
...
void LocalizerNode::relocCB(const std::shared_ptr<interface::srv::Relocalize::Request> request, 
